...
shared_file <- '~/Documents/Github/Schubert_humanCdGF_XXXX_2016/data/process/humanCdGF_full.shared'
...
rel_abund_stool <- 100 * stool_shared / apply(stool_shared, 1, sum)
#Create vector of OTUs with median abundances >1%
otu_presence <- ifelse(rel_abund_stool >= (1/2000), T, F) 
OTUs_present <- colnames(rel_abund_stool[ , apply(otu_presence, 2, sum) > round(otu_presence_cutoff*nrow(rel_abund_stool))])
