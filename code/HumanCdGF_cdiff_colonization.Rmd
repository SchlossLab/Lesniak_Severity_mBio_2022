...
for(i in 1:100){
  ...
  set.seed(seed)
  randomized_cfu_src_rf <- randomForest(cfu_all_src_shared_df[ , -1], random_cfu,
                           ntree = 501,
                           mtry = 15)
...
for(i in 1:100){
  ...
  set.seed(seed)
  randomized_wo581_rf <- randomForest(cfu_wo581_df[ , -1], random_cfu,
                           ntree = 501,
                           mtry = 15)
...
for(i in 1:100){
  ...
  set.seed(seed)
  randomized_wo_hilo_rf <- randomForest(cfu_wo_hilo_df[ , -1], random_cfu,
                           ntree = 501,
                           mtry = 15)
...
dist_cl <- vegdist(nmds_df[,-c(1,2)])
nmds <- metaMDS(nmds_df[,-c(1:2)])
stressplot(nmds, dist_cl)
plot(nmds, type = 'n')
