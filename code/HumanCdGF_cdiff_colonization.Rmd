...
meta_data <- filter(meta_data, !is.na(log_cfu))
...
*** 
***
I did notice that the way I was selecting samples (Day == 0) was removing a cage, since there was no CFU recorded for Day 0. This cage is higher in CFU and does have an effect on CFU however without any CFU data for day 0 it is not completely clear there was no CDI present at day 0. 
...
```{r all without 581 or 1134/1146}
...
data.frame(Observed = cfu_wo_hilo_df$log_cfu_med, 
