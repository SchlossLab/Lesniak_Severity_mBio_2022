...
cfu_plot <- metadata %>% 
  ...
  ggplot(aes(x = donor_source, y = cdiff_cfu, color = isolate_431)) + 
    ...
    geom_text(x = 2.75, y = 1.65, label = "DECD", 
    	color = "#3588d1", size = 10/.pt) + 
    geom_text(x = 3.25, y = 1.65, label = "DECD", 
    	color = "#76406b", size = 10/.pt) + 
    ...
    labs(x = 'Donor Source', y = NULL, 
    	title = 'Day 10 *C. difficile* CFU', color = NULL)
