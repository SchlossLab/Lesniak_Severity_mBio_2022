...
#
#    Outputs files:
#         data/process/human_GF_mouse.txt
...
output_metadata <- '~/Documents/Github/Schubert_humanCdGF_XXXX_2016/data/process/human_GF_mouse.txt'
output_shared <- '~/Documents/Github/Schubert_humanCdGF_XXXX_2016/data/process/human_CdGF_all.0.03.subsample.shared'
